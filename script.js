...
function update() {
    ...
    if (ask == true) {
        if ((food < 3)) {
            alert("You have " + food + " food(s) left until game over. You can buy some food after this message. If you don't want to buy, type in 0 or click cancel. You have " + ycoins + " YCOINS. If you never want to see this message again, type in 123456789.");
            ...
            alert("You have " + sanity + " sanity left until game over. Pick a number between 1 and 10. If you get it right, you will get some sanity. If you don't want to pick a number, click cancel in the next message. If you never want to see this message again, type in 123456789.");
...
function scene26() {
    storyText.innerHTML = "You can get a pet. Would you get one? If you do, you will use 100,000 YCOINS and 2 foods but gain 50 sanity.";
...
function scene27() {
    ...
    storyText.innerHTML = "You got a pet. You used 100,000 YCOINS and 2 foods but got 50 sanity. ";
    buttonContainer.innerHTML = "<button onclick = 'scene24()'>Work</button>";
    gameContainer.style.backgroundImage = "url('https://parade.com/wp-content/uploads/2019/04/pet-quotes.jpg')";
...
function reScene2() {
    ...
    gameContainer.style.backgroundImage = "url('https://static.thenounproject.com/png/976434-200.png')";
...
function reScene3() {
    ...
    buttonContainer.innerHTML = "<button onclick = 'reScene4()'>Next</button>";
    gameContainer.style.backgroundImage = "url('https://seeklogo.com/images/N/no-food-logo-764EA6FD7F-seeklogo.com.png')";

    update();
}

function reScene4() {
    storyText.innerHTML = "You see a person that needs help. Will you help? If you do, you loose 2 foods but get 50 sanity and 250000 YCOINS. You also might get the virus.";
...
function reScene11() {
    storyText.innerHTML = "You are suffering from the virus. You might survive or die.";
...
function reScene14() {
    ...
    buttonContainer.innerHTML = "<button onclick = 'redirect1()'>Next</button>";
    gameContainer.style.backgroundImage = "url('https://safety4sea.com/wp-content/uploads/2017/06/Maritime-NZ-in-cold-water-1-e1538639578557-750x375.png')";
...
function generator() {
    ...
    console.log(int1, int2, whatSign[signPick], answer);
    var question = prompt(int1 + " " + whatSign[signPick] + " " + int2);
    
    if (question == answer) {
        if (question == answer && counter == 3) {
            alert("Correct");
            pQuestionRight += 1;
            buttonContainer.innerHTML = "<button onclick = 'gScene6_2()'>See result</button>";
        } else {
            pQuestionRight += 1;
            alert("Correct");
            counter += 1;
...
function gScene1_2() {
    gameContainer.style.backgroundImage = "url('https://static.independent.co.uk/s3fs-public/thumbnails/image/2017/07/18/09/666f5ff0f537707922f82bd4521e832c.jpg')";
...
function generator2() {
    ...
    var num2Pick = Math.floor(Math.random()*num2.length);
    var int1_2 = Math.floor(Math.random()*num2[num2Pick]);
    var int2_2 = Math.floor(Math.random()*num2[num2Pick]);
    var whatSign2 = ["+", "-", "x"];
    var signPick2 = Math.floor(Math.random()*whatSign2.length);
    
    if (whatSign2[signPick2] == "+") {
        answer2 = int1_2 + int2_2;
        console.log(answer2);
    } else if (whatSign2[signPick2] == "-") {
        answer2 = int1_2 - int2_2;
        console.log(answer2);
    } else if (whatSign2[signPick2] == "x") {
        answer2 = int1_2 * int2_2;
        console.log(answer2);
    }

    console.log(int1_2, int2_2, whatSign2[signPick2]);
    var question2 = prompt(int1_2 + " " + whatSign2[signPick2] + " " + int2_2);
    
    if (question2 == answer2) {
        if (question2 == answer2 && counter2 == 3) {
            alert("Correct");
            correct2 += 1;
            buttonContainer.innerHTML = "<button onclick = 'gScene6_3()'>See result</button>";
        } else {
            correct2 += 1;
            counter2 += 1;
            alert("Correct");
...
//     if (question2 == answer2 && one2 == true) {
//         alert("Correct");
//         correct += 1;
//         one2 = false;
//         gScene2_3();
//     } if (question2 == answer2 && two2 == true) {
//         alert("Correct");
//         correct += 1;
//         two2 = false;
//         gScene3_3();
//     } if (question2 == answer2 && three2 == true) {
//         alert("Correct");
//         correct += 1;
//         three2 = false;
//         gScene4_3();
//     } if (question2 == answer2 && four2 == true) {
//         alert("Correct");
//         correct += 1;
//         four2 = false;
//         gScene5_3();
...
function gScene6_3() {
    ...
    if (correct2 == 0) {
        gameContainer.style.backgroundImage = "url('https://www.pngkey.com/png/detail/252-2522572_4-star-stars-in-a-line.png')";
        storyText.innerHTML = "You got 0 out of 4 right. Click next to move on.";
        buttonContainer.innerHTML = "<button onclick = 'reScene46()'>Next</button>";
